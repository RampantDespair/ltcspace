...
__EXTERNAL_DATA_SERVER_MEMPOOL_API__=${EXTERNAL_DATA_SERVER_MEMPOOL_API:=https://litecoinspace.org/api/v1}
__EXTERNAL_DATA_SERVER_MEMPOOL_ONION__=${EXTERNAL_DATA_SERVER_MEMPOOL_ONION:=http://litecoinmempjyactki6qm7tqcok7wbp3qq7vsuyimbxewznm7m2eu2nyd.onion/api/v1}
...
# MEMPOOL_SERVICES
__MEMPOOL_SERVICES_API__=${MEMPOOL_SERVICES_API:="https://litecoinspace.org/api/v1/services"}
