...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription($localize`:@@meta.description.about:Learn more about Litecoin Space\: the open-source Litecoin mempool and blockchain explorer maintained by the Litecoin Foundation.`);
