...
export class BlockSizesWeightsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.block-sizes:See Litecoin block sizes (MB) and block weights (weight units) visualized over time.`);
